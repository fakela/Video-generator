...
export const Scene13Step5: React.FC = () => {
  ...
  // "Step 5" fade up (frame 20)
  const step5Opacity = interpolate(frame, [20, 40], [0, 1], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
  const step5TranslateY = interpolate(frame, [20, 40], [30, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
      ...
      >
        ...
        <div
          style={{
            ...
            transform: `translateY(${step5TranslateY}px)`,
          }}
        >
          Step 5
        </div>
        ...
        >
          Every dollar generated goes back to the Curetopia treasury to fund the next cure. The flywheel never stops.
        </div>
      </div>
    </SceneWrapper>
  );
