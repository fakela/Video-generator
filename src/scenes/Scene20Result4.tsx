...
export const Scene20Result4: React.FC = () => {
  ...
  // 1. "8,500 compounds" — spring zoom in at frame 10
  ...
  // 2. "screened via yeast avatars" — fade up at frame 35
  ...
  // 3. "In a fraction of the time..." — fade up at frame 55
