...
export const Scene1Title: React.FC = () => {
  ...
  // 1. Logo — scale pulse between 0.95-1.05, glowing purple
  const logoPulse = Math.sin(frame * 0.1) * 0.05 + 1.0;
  const logoGlow = Math.sin(frame * 0.08) * 8 + 16;
  ...
  // 4. "Wasn't the End of the Story?" — slide from right with fade
  const storyOpacity = interpolate(frame, [60, 85], [0, 1], {
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });
  const storyX = interpolate(frame, [60, 85], [80, 0], {
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });
  ...
  const rewriteGlow = interpolate(frame, [100, 130], [0, 12], {
    extrapolateRight: "clamp",
    extrapolateLeft: "clamp",
  });
  ...
  return (
    <SceneWrapper>
      ...
      >
        {/* 1. Curetopia logo — scale pulse with glow */}
        <div
          style={{
            fontFamily: poppins,
            fontSize: 48,
            ...
            textShadow: `0 0 ${logoGlow}px rgba(168, 85, 247, 0.8), 0 0 ${logoGlow * 2}px rgba(168, 85, 247, 0.4)`,
          }}
        >
          {"\uD83E\uDDEC"} CURETOPIA
        </div>
        ...
        {/* 4. "Wasn't the End of the Story?" — slide from right */}
        <div
          style={{
            fontFamily: poppins,
            fontSize: 64,
            ...
            transform: `translateX(${storyX}px)`,
          }}
        >
