...
export const SceneStep6PatientFamilies: React.FC = () => {
  ...
  // "STEP 6" label — fade + scale at frame 18
  ...
  // Title — spring punch at frame 28
  ...
  // Description — blur-in at frame 48
  ...
  return (
    <SceneWrapper>
      ...
      >
        ...
        >
          Real families run N-of-1 observational trials — as co-owners of the
          cure.
        </div>
      </div>
    </SceneWrapper>
